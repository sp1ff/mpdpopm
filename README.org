...
#+BEGIN_SRC bash
cd /tmp
curl -L --output mpdpopm-0.3.6.tar.gz https://github.com/sp1ff/mpdpopm/releases/download/0.3.6/mpdpopm-0.3.6-x86_64-unknown-linux.tar.gz
tar xf mpdpopm-0.3.6.tar.gz
tree mpdpopm-0.3.6-x86_64-unknown-linux/
mpdpopm-0.3.6-x86_64-unknown-linux/
├── bin
│   ├── mppopm
│   └── mppopmd
└── doc
...
#+BEGIN_SRC bash
cd /tmp
curl -L -O https://github.com/sp1ff/mpdpopm/releases/download/0.3.6/mpdpopm_0.3.6_amd64.deb
sudo dpkg -i mpdpopm_0.3.6_amd64.deb
#+END_SRC
...
#+BEGIN_SRC bash
cd /tmp
curl -L -O https://github.com/sp1ff/mpdpopm/releases/download/0.3.6/mpdpopm-0.3.6.tar.xz
tar xf mpdpopm-0.3.6.tar.xz
cd mpdpopm-0.3.6
./configure
make
make check
