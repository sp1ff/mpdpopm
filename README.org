...
#+BEGIN_SRC bash
cd /tmp
curl -L --output mpdpopm-0.2.0.tar.gz https://github.com/sp1ff/mpdpopm/releases/download/0.2.0/mpdpopm-0.2.0-x86_64-unknown-linux.tar.gz
tar xf mpdpopm-0.2.0.tar.gz
tree mpdpopm-0.2.0-x86_64-unknown-linux/
mpdpopm-0.2.0-x86_64-unknown-linux/
├── bin
│   ├── mppopm
│   └── mppopmd
└── doc
...
#+BEGIN_SRC bash
cd /tmp
curl -L -O https://github.com/sp1ff/mpdpopm/releases/download/0.2.0/mpdpopm_0.2.0_amd64.deb
sudo dpkg -i mpdpopm_0.2.0_amd64.deb
#+END_SRC
...
#+BEGIN_SRC bash
cd /tmp
curl -L -O https://github.com/sp1ff/mpdpopm/releases/download/0.2.0/mpdpopm-0.2.0.tar.xz
tar xf mpdpopm-0.2.0.tar.xz
cd mpdpopm-0.2.0
./configure
make
make check
...
[2020-12-12T15:26:19.620806454-08:00][mppopmd] mppopmd 0.2.0 logging at level Debug.
[2020-12-12T15:26:19.621395828-08:00][mpdpopm] mpdpopm 0.2.0 beginning.
